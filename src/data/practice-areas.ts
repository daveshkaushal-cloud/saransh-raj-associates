...
export const practiceAreas: PracticeArea[] = [
  {
    ...
    short: "Corporate structuring, governance and ongoing advisory.",
    overview:
      "Corporate structuring, governance and ongoing advisory across the business lifecycle — from entity formation and shareholder arrangements through to board governance, regulatory compliance and corporate restructuring.",
    services: [
  ...
  },
  {
    ...
    short: "Drafting and review of commercial agreements.",
    overview:
      "Drafting and review of commercial agreements — from supply, distribution and service contracts to licensing, IP and joint venture arrangements — with attention to scope, risk allocation, enforceability and commercial alignment.",
    services: [
  ...
  },
  {
    ...
    short: "Transaction structuring, documentation and due diligence.",
    overview:
  ...
  },
  {
    ...
    short: "Commercial litigation and arbitration.",
    overview:
      "Commercial litigation and arbitration — representation in commercial disputes before arbitrations, the National Company Law Tribunal and the commercial courts, with attention to efficient resolution and the preservation of commercial positions.",
    services: [
  ...
  },
  {
    ...
    short: "Business and sector-specific regulatory advice.",
    overview:
      "Business and sector-specific regulatory advice — support in understanding and complying with applicable laws and regulations, from SEBI and RBI frameworks to sector-specific compliance, with a proactive approach that seeks to identify risk before it becomes liability.",
    services: [
  ...
  },
  {
    ...
    short: "Insolvency proceedings and recovery matters.",
    overview:
      "Insolvency proceedings and recovery matters — advice to creditors, debtors and resolution professionals on proceedings under the Insolvency and Bankruptcy Code, from initiating proceedings to resolution plan negotiations and asset recovery.",
    services: [
