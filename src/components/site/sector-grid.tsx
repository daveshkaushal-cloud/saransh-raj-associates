  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <Link
          href="/sectors"
          className="group relative block snap-start shrink-0 w-[60vw] sm:w-[40vw] md:w-[16rem] lg:w-[14rem] bg-stone text-ink border border-line-strong overflow-hidden"
        >
          <div className="relative h-[10rem] md:h-[11rem] p-5 md:p-6 flex flex-col justify-between">
            <span className="mono-label text-ink/70">All sectors</span>
            <div>
              <h3 className="display-3 text-base md:text-lg text-ink leading-tight">
                View the full index
              </h3>
              <div className="mt-3 flex items-center gap-2 text-sm font-medium text-ink/70 group-hover:text-copper transition-colors">
                <span>See all</span>
      ...
      <div className="mt-5 flex items-center gap-4">
        <span className="mono-num text-stone-dark font-medium">
...
function SectorCard({
  ...
  return (
    <a
      ...
      className="group relative block bg-porcelain border border-line overflow-hidden transition-colors duration-300 hover:border-copper focus-visible:border-copper p-5 md:p-6 min-h-[10rem] flex flex-col"
    >
      ...
      <div className="mt-auto pt-4 flex items-center gap-2 text-sm font-medium text-charcoal group-hover:text-copper transition-colors">
...
function SectorTile({
  ...
  return (
    <a
      href={`/sectors#${sector.slug}`}
      className="group relative block shrink-0 snap-start bg-porcelain border border-line overflow-hidden transition-colors duration-300 hover:border-copper focus-visible:border-copper flex flex-col"
    >
...
function SectorArrow({
  ...
  return (
    <button
      ...
      className="inline-flex items-center justify-center h-9 w-9 border border-line-strong text-stone-dark hover:text-ink hover:bg-ivory transition-colors duration-200 disabled:opacity-30 disabled:cursor-not-allowed disabled:hover:bg-transparent disabled:hover:border-line-strong"
    >
