 ...
 * Always renders the full styled disclaimer overlay upon page load or refresh.
 */
export function DisclaimerGateClient({
  ...
  return (
    ...
    >
      <DisclaimerContent
        onAgree={() => {
          // Simply update state to reveal the site for the current view.
          // No cookie or localStorage is set, ensuring it prompts again on reload.
          setProceeded(true);
        }}
      />
    </div>
