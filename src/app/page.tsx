...
export default function HomePage() {
  return (
    <>
      ...
      <section className="relative min-h-[88svh] flex flex-col bg-surface overflow-hidden">
        ...
        <div className="relative z-10 flex-1 mx-auto max-w-[1600px] w-full px-5 md:px-10 pt-10 md:pt-16 pb-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
            ...
            {/* Right: document layers — visible immediately, no framer-motion delay */}
            <div className="lg:col-span-5 lg:pl-6">
              <div className="relative h-[38vh] md:h-[52vh] lg:h-[60vh] w-full">
                <HeroVisual />
              </div>
            </div>
          </div>
      ...
      <section className="relative bg-surface py-10 md:py-16">
        <div className="mx-auto max-w-[1600px] px-5 md:px-10">
      ...
      {/* ============== SECTORS ============== */}
      <section className="bg-surface-soft py-14 md:py-20 relative overflow-hidden border-y border-line">
      ...
      {/* ============== PEOPLE PREVIEW ============== */}
      <section className="bg-surface py-14 md:py-20 border-t border-line">
        <div className="mx-auto max-w-[1600px] px-5 md:px-10">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
            <div>
      ...
      {/* ============== INSIGHTS PREVIEW ============== */}
      <section className="bg-surface-soft text-fg py-14 md:py-20 relative overflow-hidden">
        <div className="relative mx-auto max-w-[1600px] px-5 md:px-10">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
            <div>
      ...
      {/* ============== CONTACT ============== */}
      <section className="bg-surface py-14 md:py-20 relative overflow-hidden">
        <div className="mx-auto max-w-[1600px] px-5 md:px-10">
...
function PracticeIndex() {
  return (
    <section className="relative bg-surface py-8 md:py-12 border-b border-line">
      <div className="mx-auto max-w-[1600px] px-5 md:px-10">
          ...
          {practiceAreas.map((area, i) => {
            ...
            return (
              <div key={area.slug}>
                <Link
                  href={`/expertise/${area.slug}`}
                  className="group relative grid grid-cols-12 gap-4 items-center py-3 md:py-4 border-b border-line hover:bg-surface-soft transition-colors"
                >
                  <span
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        {principles.map((p, i) => {
          ...
          return (
            <div key={p.title}>
              <div
                className="relative h-full min-h-[11rem] p-6 md:p-7 flex flex-col justify-between border-r border-b border-line last:border-r-0"
