...
import { DisclaimerGate } from "@/components/site/disclaimer-gate";
import { WhatsappButton } from "@/components/whatsapp-button"; // or "@/components/site/whatsapp-button" depending on where you saved it
