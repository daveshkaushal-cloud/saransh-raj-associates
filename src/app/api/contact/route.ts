...
const CONTACT_EMAIL =
  ...
  "office@saranshrajassociates.co.in";
...
async function deliverEnquiry({
  ...
  const response = await fetch("https://api.resend.com/emails", {
    ...
    headers: {
      ...
      // Resend may reject otherwise valid requests with a 403/1010 when the
      // HTTP client does not provide an identifiable User-Agent.
      "User-Agent":
        "SaranshRajAssociates-Website/1.0 (+https://www.saranshrajassociates.co.in)",
    },
    body: JSON.stringify({
